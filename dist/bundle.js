...
/******/
/******/ 	// Load entity module and return exports
...
function lifecycleMixin (Vue) {
  Vue.prototype._update = function (vnode, hydrating) {
    ...
    activeInstance = vm;
    vm._vnode = vnode;
    // Vue.prototype.__patch__ is injected in entity points
...
var vuetify_1 = __webpack_require__(21);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_13_5_0_vue_loader_lib_selector_type_script_index_0_bustCache_App_vue__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_13_5_0_vue_loader_lib_selector_type_script_index_0_bustCache_App_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_13_5_0_vue_loader_lib_selector_type_script_index_0_bustCache_App_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_5_0_vue_loader_lib_template_compiler_index_id_data_v_04c2046b_hasScoped_false_buble_transforms_node_modules_vue_loader_13_5_0_vue_loader_lib_selector_type_template_index_0_bustCache_App_vue__ = __webpack_require__(20);
var disposed = false
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_13_5_0_vue_loader_lib_selector_type_script_index_0_bustCache_App_vue___default.a,
...
Component.options.__file = "src\\FirstPage.vue"
...
var update = __webpack_require__(12)("1c1ac68e", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/_css-loader@0.28.7@css-loader/index.ts?sourceMap!../node_modules/_vue-loader@13.5.0@vue-loader/lib/style-compiler/index.ts?{\"vue\":true,\"id\":\"data-v-04c2046b\",\"scoped\":false,\"hasInlineConfig\":false}!../node_modules/_vue-loader@13.5.0@vue-loader/lib/selector.js?type=styles&index=0&bustCache!./FirstPage.vue", function() {
...
// module
exports.push([module.i, "\n.title {\n}\n", "", {"version":3,"sources":["F:/vue-ts-demo-template/vue-ts-demo-template/src/src/FirstPage.vue?2760b6e8"],"names":[],"mappings":";AA4MA;CAEA","file":"FirstPage.vue","sourcesContent":["<template>\n    <v-app>\n        <v-container grid-list-md text-xs-center>\n            <v-layout row wrap>\n                <v-flex xs12>\n                    <div>\n                        <h1 class=\"title\">Vue + Typescript(Template风格)</h1>\n                        <v-divider></v-divider>\n                        <h2 class=\"title\">Summary Information</h2>\n                        <div>\n\t\t\t\t\t\t<span v-for=\"book in books\">\n\t\t\t\t\t\t\t <v-chip>{{book.name}}</v-chip>\n\t\t\t\t\t\t</span>\n                        </div>\n                        <h2 class=\"title\">Detail Information</h2>\n                        <book-list :books=\"books\"></book-list>\n                        <v-divider></v-divider>\n                        <h2>Reset</h2>\n                        <v-btn  @click=\"reset\" color=\"primary\">Reset</v-btn>\n                        <v-divider></v-divider>\n                        <h2 class=\"title\">table</h2>\n                        <v-data-table\n                                v-bind:headers=\"headers\"\n                                :items=\"items\"\n                                hide-actions\n                                class=\"elevation-1\"\n                        >\n                            <template slot=\"items\" slot-scope=\"props\">\n                                <td>{{ props.item.name }}</td>\n                                <td class=\"text-xs-right\">{{ props.item.calories }}</td>\n                                <td class=\"text-xs-right\">{{ props.item.fat }}</td>\n                                <td class=\"text-xs-right\">{{ props.item.carbs }}</td>\n                                <td class=\"text-xs-right\">{{ props.item.protein }}</td>\n                                <td class=\"text-xs-right\">{{ props.item.sodium }}</td>\n                                <td class=\"text-xs-right\">{{ props.item.calcium }}</td>\n                                <td class=\"text-xs-right\">{{ props.item.iron }}</td>\n                            </template>\n                        </v-data-table>\n                    </div>\n                </v-flex>\n            </v-layout>\n        </v-container>\n    </v-app>\n</template>\n\n<script lang=\"ts\">\n    import Vue from 'vue';\n    import Component from 'vue-class-component';\n    import BookList from './BookList.vue';\n    import Book from \"./domain/Book\";\n\n    @Component({\n        components: {\n            \"book-list\": BookList\n        }\n    })\n    export default class App extends Vue {\n\n        private books: Array<Book> = []; //Vue属性具备变更通知,必须具备初值（这是唯一的限制，后续可以随便整体覆盖，没有react + mobx那么恶心）\n        headers: Array<any> = [\n            {\n                text: 'Dessert (100g serving)',\n                align: 'left',\n                sortable: false,\n                value: 'name'\n            },\n            {text: 'Calories', value: 'calories'},\n            {text: 'Fat (g)', value: 'fat'},\n            {text: 'Carbs (g)', value: 'carbs'},\n            {text: 'Protein (g)', value: 'protein'},\n            {text: 'Sodium (mg)', value: 'sodium'},\n            {text: 'Calcium (%)', value: 'calcium'},\n            {text: 'Iron (%)', value: 'iron'}\n        ];\n        items: Array<any> = [\n            {\n                value: false,\n                name: 'Frozen Yogurt',\n                calories: 159,\n                fat: 6.0,\n                carbs: 24,\n                protein: 4.0,\n                sodium: 87,\n                calcium: '14%',\n                iron: '1%'\n            },\n            {\n                value: false,\n                name: 'Ice cream sandwich',\n                calories: 237,\n                fat: 9.0,\n                carbs: 37,\n                protein: 4.3,\n                sodium: 129,\n                calcium: '8%',\n                iron: '1%'\n            },\n            {\n                value: false,\n                name: 'Eclair',\n                calories: 262,\n                fat: 16.0,\n                carbs: 23,\n                protein: 6.0,\n                sodium: 337,\n                calcium: '6%',\n                iron: '7%'\n            },\n            {\n                value: false,\n                name: 'Cupcake',\n                calories: 305,\n                fat: 3.7,\n                carbs: 67,\n                protein: 4.3,\n                sodium: 413,\n                calcium: '3%',\n                iron: '8%'\n            },\n            {\n                value: false,\n                name: 'Gingerbread',\n                calories: 356,\n                fat: 16.0,\n                carbs: 49,\n                protein: 3.9,\n                sodium: 327,\n                calcium: '7%',\n                iron: '16%'\n            },\n            {\n                value: false,\n                name: 'Jelly bean',\n                calories: 375,\n                fat: 0.0,\n                carbs: 94,\n                protein: 0.0,\n                sodium: 50,\n                calcium: '0%',\n                iron: '0%'\n            },\n            {\n                value: false,\n                name: 'Lollipop',\n                calories: 392,\n                fat: 0.2,\n                carbs: 98,\n                protein: 0,\n                sodium: 38,\n                calcium: '0%',\n                iron: '2%'\n            },\n            {\n                value: false,\n                name: 'Honeycomb',\n                calories: 408,\n                fat: 3.2,\n                carbs: 87,\n                protein: 6.5,\n                sodium: 562,\n                calcium: '0%',\n                iron: '45%'\n            },\n            {\n                value: false,\n                name: 'Donut',\n                calories: 452,\n                fat: 25.0,\n                carbs: 51,\n                protein: 4.9,\n                sodium: 326,\n                calcium: '2%',\n                iron: '22%'\n            },\n            {\n                value: false,\n                name: 'KitKat',\n                calories: 518,\n                fat: 26.0,\n                carbs: 65,\n                protein: 7,\n                sodium: 54,\n                calcium: '12%',\n                iron: '6%'\n            }\n        ];\n\n        private created() {\n            Vue.nextTick(() => this.reset());\n        }\n\n        private reset(): Array<Book> {\n            return this.books = [\n                {name: 'C#', author: 'Frank', price: 23},\n                {name: 'Java', author: 'Derek', price: 25},\n                {name: 'C++', author: 'Alex', price: 28},\n                {name: 'TypeScript', author: 'Jessica', price: 26},\n                {name: 'SQL', author: 'William', price: 24}\n            ];\n        }\n    }\n</script>\n\n<style>\n    .title {\n\n    }\n</style>\n"],"sourceRoot":""}]);
...
var BookList_vue_1 = __webpack_require__(15);
var App = (function (_super) {
    ...
    App.prototype.created = function () {
        var _this = this;
        vue_1.default.nextTick(function () { return _this.reset(); });
    };
    ...
    App = __decorate([
        vue_class_component_1.default({
            components: {
                "book-list": BookList_vue_1.default
            }
        })
    ], App);
    return App;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_13_5_0_vue_loader_lib_selector_type_script_index_0_bustCache_BookList_vue__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_13_5_0_vue_loader_lib_selector_type_script_index_0_bustCache_BookList_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_13_5_0_vue_loader_lib_selector_type_script_index_0_bustCache_BookList_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_5_0_vue_loader_lib_template_compiler_index_id_data_v_cc2bed66_hasScoped_false_buble_transforms_node_modules_vue_loader_13_5_0_vue_loader_lib_selector_type_template_index_0_bustCache_BookList_vue__ = __webpack_require__(19);
var disposed = false
var normalizeComponent = __webpack_require__(4)
/* script */
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__ts_loader_node_modules_vue_loader_13_5_0_vue_loader_lib_selector_type_script_index_0_bustCache_BookList_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_5_0_vue_loader_lib_template_compiler_index_id_data_v_cc2bed66_hasScoped_false_buble_transforms_node_modules_vue_loader_13_5_0_vue_loader_lib_selector_type_template_index_0_bustCache_BookList_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\BookList.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-cc2bed66", Component.options)
  } else {
    hotAPI.reload("data-v-cc2bed66", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var App = (function (_super) {
    ...
    App.prototype.onDelete = function (index) {
        this.books.splice(index, 1);
    };
    __decorate([
        vue_property_decorator_1.Prop()
    ], App.prototype, "books", void 0);
    App = __decorate([
        vue_class_component_1.default
    ], App);
    return App;
...
(function (global, factory) {
	 true ? factory(exports, __webpack_require__(0), __webpack_require__(3), __webpack_require__(18)) :
...
(function (Reflect) {
    ...
    /**
      ...
      * @param metadataValue The value for the metadata entity.
    ...
    /**
      * Define a unique metadata entity on the target.
    ...
    /**
      * Deletes the metadata entity from the target object with the provided key.
      * @param metadataKey A key used to store and retrieve metadata.
      * @param target The target object on which the metadata is defined.
      * @param propertyKey (Optional) The property key for the target.
      * @returns `true` if the metadata entity was found and deleted; otherwise, false.
      * @example
      *
      *     class Example {
      *         // property declarations are not part of ES6, though they are valid in TypeScript:
        ...
        _c(
          ...
          [
            _c("div", [
              ...
              _vm._v(" "),
              _c("div", [_vm._v("Author: " + _vm._s(book.author))]),
              _vm._v(" "),
              _c("div", [_vm._v("Price: " + _vm._s(book.price))])
            ]),
            _vm._v(" "),
            _c(
              "div",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-cc2bed66", esExports)
  }
}
                ...
                _c(
                  ...
                  [
                    _c("h1", { staticClass: "title" }, [
                      _vm._v("Vue + Typescript(Template风格)")
                    ]),
                    _vm._v(" "),
                    _c("v-divider"),
                    _vm._v(" "),
                    ...
                    _c(
                      ...
                      _vm._l(_vm.books, function(book) {
                        return _c(
                          "span",
                          [_c("v-chip", [_vm._v(_vm._s(book.name))])],
                          1
                        )
                      })
                    ),
                    ...
                    _vm._v(" "),
                    _c("book-list", { attrs: { books: _vm.books } }),
                    _vm._v(" "),
                    _c("v-divider"),
                    _vm._v(" "),
                    _c("h2", [_vm._v("Reset")]),
                    ...
                    _c("v-divider"),
                    _vm._v(" "),
                    _c("h2", { staticClass: "title" }, [_vm._v("table")]),
                    _vm._v(" "),
                    _c("v-data-table", {
